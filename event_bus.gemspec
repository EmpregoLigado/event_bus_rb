...
Gem::Specification.new do |spec|
  ...
  spec.summary       = %q{Expose a api to produce and consume events.}
  spec.description   = %q{Expose a api to produce and consume events.}
  ...
  if spec.respond_to?(:metadata)
    spec.metadata['allowed_push_host'] = "http://gems.empregoligado.com.br"
  else
